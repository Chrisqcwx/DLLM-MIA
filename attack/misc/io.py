...
def save_metadata(
    metadata: Dict[str, Any], output_dir: str, filename: str = "metadata.pkl"
) -> None:
...
def generate_metadata_filename(
    ...
    from .dataset import get_printable_ds_name
    ...
    filename = (
        f"metadata_{current_time}_model-{model_name_base}_config-{config_base_name}_"
