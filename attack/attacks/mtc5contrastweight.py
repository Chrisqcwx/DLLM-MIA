...
class Mtc5contrastweightAttack(AbstractAttack):
    """
    ...
    def _compute_token_weights(self, input_ids_ref, attention_mask_ref):
        ...
        weights = (ref_ce - ce) * attention_mask_ref.float().to(self.ref_device)
        ...
        weights = weights / weights.sum(dim=1, keepdim=True)  # (B, L), 归一化为概率
