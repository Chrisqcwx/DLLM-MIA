...
class MtinrefAttack(AbstractAttack):
    """
    ...
    def __init__(self, name: str, model, tokenizer, config, device: torch.device):
        ...
        self.use_hidden_states = int(config.get("use_hidden_states", -1))
    ...
    def _forward(self, model, inputs):
        ...
        hidden_state = hidden_states[self.use_hidden_states]
