...
class SamalossupdatenorandomAttack(AbstractAttack):
    """
    ...
    def _compute_batch_scores(self, texts, batch_start_idx):
        ...
        for step in range(self.num_steps):
            ...
            with torch.no_grad():
                ...
                cumulative_target_losses[cumulative_mask] = ce[cumulative_mask]
            ...
            with torch.no_grad():
                ...
                cumulative_ref_losses[cumulative_mask_ref] = ce_r[cumulative_mask_ref]
