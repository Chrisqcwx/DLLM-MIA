...
for exp_name in LLaDA-8B-Base-pretrained-mimir-github-4_12_1.0e-4_10_512-lora3 \
LLaDA-8B-Base-pretrained-mimir-github-4_12_1.0e-4_10_512-lora4 \
    ; do
...
for config_name in config_mtc5noboxbool config_mtc5noboxminus config_mtc5noboxminusrelu; do
